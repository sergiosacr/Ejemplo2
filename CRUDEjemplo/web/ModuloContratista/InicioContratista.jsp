          ...
          <div class="wrapper">
            <nav id="sidebar">
                ...
                <ul class="list-unstyled components">
                    <p style="font-weight: bold; color: #000" class="lead">Contratista</p>
                    <li>
                        ...
                        <ul class="collapse list-unstyled" id="mSub1">
                            ...
                            <li>
                                <a href="html-admin/a1RegistrarProyecto.html" target="workSection">Registrar Proyecto</a>
                            </li>
                            <li>
                                <a href="html-admin/a1ConsultarProyecto.html" target="workSection">Consultar Proyecto</a>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul class="collapse list-unstyled" id="mSub3">
                            ...
                            <li>
                                <a href="html-admin/a3RegistrarMateriales.html" target="workSection">Registrar Materiales</a>
                            </li>
                            <li>
                                <a href="html-admin/a3ConsultarMateriales.html" target="workSection">Consultar Materiales</a>
                            </li>
                            <li>
                                <a href="html-admin/a3RegistrarHerramientas.html" target="workSection">Registrar Herramientas</a>
                            </li>
                            <li>
                                <a href="html-admin/a3ConsultarHerramientas.html" target="workSection">Consultar Herramientas</a>
                            </li>
                        </ul> 
                    </li>
                </ul>
            ...
            <div class="container-fluid">
                ...
                <div role="main" class="col-md-12 ml-sm-auto col-lg-12 px-3">
                    ...
                    <section class="">
                        <iframe name="workSection" src="ModuloContratista/BienvenidoContratista.jsp"></iframe>
                    </section> 
                </div>
