        ...
        <div class="wrapper">
            <nav id="sidebar">
                ...
                <ul class="list-unstyled components">
                    <p style="font-weight: bold; color: #000" class="lead">Cliente</p>
                    <li>
                        ...
                        <ul class="collapse list-unstyled" id="mSub1">
                            ...
                            <li>
                                <a href="<%= request.getContextPath()%>/CtrGeneral?accion=_________" target="workSection">Consultar Proyecto</a>
                            </li>
                            
                            <li>
                <a href="<%= request.getContextPath()%>/CtrGeneral?accion=Listacotizacion" target="workSection">Consultar Cotización</a>
            ...
            <div class="container-fluid">
                ...
                <div role="main" class="col-md-12 ml-sm-auto col-lg-12 px-3">
                    ...
                    <section class="">
                        <iframe name="workSection" src="ModuloCliente/BienvenidoCliente.jsp"></iframe>
                    </section> 
                </div>
